...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('img/logokkp_putih.png') }}" rel="icon">
  ...
  <link href="assets/css/wa.min.css" rel="stylesheet">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <div class="d-grid gap-2 col-8">
              ...
              <img src="{{ asset('img/whatsapp.png') }}" width="10%"> Pengaduan LPSPL Sorong</button></a>
              ...
              <a href="https://api.whatsapp.com/send?phone=+6281341745454&text=Halo%20Admin%20Pelayanan%20LPSPL%20Sorong" class="btn btn-success mt-2" target="_blank">
                <img src="{{ asset('img/whatsapp.png') }}" width="10%"> Pelayanan LPSPL Sorong</button></a>
            </div> 
